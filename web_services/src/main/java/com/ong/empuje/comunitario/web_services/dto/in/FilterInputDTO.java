...
public class FilterInputDTO {
    ...
    public FilterInputDTO(String name, Integer categoryId, LocalDateTime startDate, LocalDateTime endDate, Boolean filterDeleted, Boolean deleted, String username) {
        this.name = name;
